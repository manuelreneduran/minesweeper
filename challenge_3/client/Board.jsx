...
import { isGameOver, isStrikeCounterActive, isRollStrike, isNewFrame, isRollTwo, calculateFrameTotal, isRollSpare, handleGameOver, decrementStrikeCounter, handleStrike, getNextRoll } from './controllers/ScoreTableHelpers.js';
...
export default class Board extends Component {
  ...
  handleFlow(event) {
    ...
    handleGameOver(this.state.currentFrame, this.state.gameTotal);
  }
